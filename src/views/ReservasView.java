...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaE.setName("campoFechaEntrada");
		...
		lblValorSimbolo.setHorizontalAlignment(SwingConstants.CENTER);
		lblValorSimbolo.setVisible(true);
		lblValorSimbolo.setBounds(82, 332, 29, 25);
		...
		lblCheckIn.setBounds(68, 136, 247, 14);
		...
		txtFechaS.setName("campoFechaSalida");
		...
		txtValor.setBounds(116, 328, 199, 33);
		...
		lblValor.setBounds(72, 303, 243, 14);
		...
		lblTitulo.setBounds(82, 60, 275, 42);
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				Date fechaEntrada = ReservasView.txtFechaE.getDate();
				Date fechaSalida = ReservasView.txtFechaS.getDate();				
				if (fechaEntrada != null && fechaSalida != null) {	
					try {
						java.sql.Date fEntrada = new java.sql.Date(((Date) txtFechaE.getDate()).getTime());
						java.sql.Date fSalida = new java.sql.Date(((Date) txtFechaS.getDate()).getTime());
						long valorReserva = Long.valueOf(txtValor.getText());
						
						Reserva reserva = new Reserva(fEntrada, fSalida, valorReserva, txtFormaPago.getSelectedItem().toString());
						new ReservaDao(new ConnectionFactory().recuperaConexion()).guardar(reserva);
						...
						JOptionPane.showMessageDialog(null, "La fecha de entrada tiene que ser anterior a la de salida");
					}
				} else {
	...
	public static void cambiarPrecioReserva() {
		if(txtFechaE.getDate() != null && txtFechaS.getDate() != null) {
    		long precio = 0;
    	    long startTime = txtFechaE.getDate().getTime();
    	    long endTime = txtFechaS.getDate().getTime();
