...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnexit.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				int respuestaCierre = JOptionPane.showConfirmDialog(btnexit, "¿Desea salir de la aplicación?", "Cierre de aplicación", 0);
	...
	private void Login() {
		...
		UsuarioDao usuario = new UsuarioDao(new ConnectionFactory().recuperaConexion());
		
		if(usuario.loguear(txtUsuario.getText(), txtContrasena)) {
